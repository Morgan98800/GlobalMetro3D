...
def run_pipeline(force_download: bool = False) -> None:
    ...
    output_dir = os.path.join(base_dir, "cities", "paris", "data", "processed")
    if not os.path.exists(output_dir) and os.path.exists(os.path.join(base_dir, "data", "processed")):
    ...
    overrides_path = os.path.join(base_dir, "cities", "paris", "data", "sections-overrides.json")
    if not os.path.exists(overrides_path) and os.path.exists(os.path.join(base_dir, "data", "sections-overrides.json")):
