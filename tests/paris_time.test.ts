...
import { serviceCandidates, selectActiveTrips, parisClock } from '@core/sim/paris_time';

import { describe, it } from 'vitest';

describe('paris_time unit tests', () => {
  it('runs DST transitions and schedule active trip tests', () => {
