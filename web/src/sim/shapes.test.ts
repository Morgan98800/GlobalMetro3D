...
import type { ShapeEntry } from './shapes.ts';
...
function runTests() {
  ...
  // 1. Locate shapes.bin
  const possiblePaths = [
    path.resolve(__dirname, '../../public/data/shapes.bin'),
    path.resolve(__dirname, '../../../data/processed/shapes.bin'),
    path.resolve(__dirname, '../../dist/data/shapes.bin')
  ];
